# 👋 Hi, I’m Murari Komati  
**Data Engineer | Cloud, Big Data, Streaming & Analytics | GenAI-Enabled Data Platforms**

Data Engineer with proven experience designing and delivering **scalable, cloud-native data platforms** across **Azure, GCP, and AWS**.  
I specialize in **ETL/ELT pipelines, real-time streaming architectures, Delta Lake–based data modeling, and analytics-ready data platforms**, with hands-on exposure to **LLM-powered and agentic workflows** for data use cases.

I focus on **production reliability, performance optimization, and enterprise-grade data engineering practices**.
...
A multi-agent system that automates job discovery, role matching, and resume tailoring using LLM-driven workflows.  
Designed with **task orchestration, agent collaboration, and prompt governance** in mind.

➡️ **Repository:**  
https://github.com/Murarikomati/Agentic-AI-Workflow-Automation  

---

### 🔹 Customer Service RAG Chatbot (SQL-Aware)
**Tech:** LangChain · Vector Databases · SQL · Streaming Responses  

An enterprise-style RAG chatbot that converts natural language questions into SQL queries, executes them safely, and streams results in real time.  
Built with **schema awareness, retrieval validation, and grounded responses**.

➡️ **Repository:**  
https://github.com/Murarikomati/Customer-Service-RAG-chatbot  
...
- Config-driven and modular pipeline design
- Incremental and idempotent processing
- Data quality checks and assertions
- Performance optimization (partitioning, joins, caching)
